...
### Hyperparameter search (using CPU in PKU-Align-Anything dataset)

Command: `python cpu_sweep.py --config_file=run_configs/llama_linear.json --sweep-config=run_configs/sweep_default.yaml --dataset=pku --nepochs=10`
