...
from vsllib.defines import REWARD_HEADS_INDICES, REWARD_HEADS_OUTPUT, VALUE_SYSTEM_OUTPUT, SupportedDatasets, EXTRA_KEYS, PROCESSED_DATASET_PATHS, get_test_indices, get_validation_indices
...
def main_fun() -> None:
    ...
    base_model = model_full.base_model if hasattr(model_full, 'base_model') else model_full
